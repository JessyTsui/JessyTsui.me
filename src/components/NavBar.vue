  ...
  <header class="header z-40">
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <!--        </RouterLink> -->
        <a href="https://twitter.com/Jiaxi_Cui" target="_blank" title="Twitter" class="lt-md:hidden">
          <div i-ri-twitter-x-fill />
        </a>
        <a href="https://github.com/JessyTsui" target="_blank" title="GitHub" class="lt-md:hidden">
