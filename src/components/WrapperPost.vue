...
const base = 'https://JessyTsui.me'
const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @Jiaxi_Cui\'s ${base}${route.path}\n\nI think...`)}`)
const elkUrl = computed(() => `https://elk.zone/intent/post?text=${encodeURIComponent(`Reading @JessyTsui@m.webtoo.ls\'s ${base}${route.path}\n\nI think...`)}`)
