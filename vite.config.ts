    ...
    Markdown({
      ...
      async markdownItSetup(md) {
        ...
        md.use(MarkdownItMagicLink, {
          linksMap: {
            ...
            'TwoSlash': 'https://github.com/twoslashes/twoslash',
            'Jessy Tsui Collective': { link: 'https://opencollective.com/JessyTsui', imageUrl: 'https://github.com/JessyTsui-collective.png' },
          ...
          imageOverrides: [
            ...
            ['https://github.com/sponsors/JessyTsui', 'https://github.com/github.png'],
      ...
      frontmatterPreprocess(frontmatter, options, id, defaults) {
        (() => {
          ...
          frontmatter.image = `https://JessyTsui.me/${path}`
        })()
