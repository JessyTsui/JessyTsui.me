...
projects:
  ...
  Vue Ecosystem:
    ...
    - name: 'vue-template-promise'
      link: 'https://github.com/JessyTsui/vue-template-promise'
      desc: 'Template as Promise in Vue'
      icon: 'i-carbon-cics-region-routing'
    - name: 'Vue Starport'
      link: 'https://github.com/JessyTsui/vue-starport'
    ...
    - name: 'Vue Reactivity'
      ...
      icon: 'vue-reactivity'
    - name: 'ReactiVue'
      link: 'https://github.com/JessyTsui/reactivue'
    ...
    - name: 'v-dollar'
      link: 'https://github.com/JessyTsui/v-dollar'
  ...
  Nuxt Ecosystem:
    ...
    - name: 'Nuxt Server Functions'
      link: 'https://github.com/JessyTsui/nuxt-server-fn'
  ...
  Unplugins:
    ...
    - name: 'unplugin-vue-components'
      link: 'https://github.com/JessyTsui/unplugin-vue-components'
  ...
  Vite Ecosystem:
    ...
    - name: 'vite-plugin-inspect'
      link: 'https://github.com/JessyTsui/vite-plugin-inspect'
    ...
    - name: 'vite-plugin-pwa'
      ...
      icon: 'i-ion-logo-pwa'
    - name: 'vite-ssg'
      link: 'https://github.com/JessyTsui/vite-ssg'
      desc: 'Server-side generation for Vite'
      icon: 'i-carbon-printer'
    - name: 'vite-plugin-optimize-persist'
      link: 'https://github.com/JessyTsui/vite-plugin-optimize-persist'
  ...
  ESLint Ecosystem:
    ...
    - name: 'eslint-typegen'
      link: 'https://github.com/JessyTsui/eslint-typegen'
    ...
    - name: 'eslint-flat-config-utils'
      link: 'https://github.com/JessyTsui/eslint-flat-config-utils'
    ...
    - name: 'eslint-plugin-format'
      link: 'https://github.com/JessyTsui/eslint-plugin-format'
  ...
  Design / Compform:
    ...
    - name: 'p5i'
      link: 'https://github.com/JessyTsui/p5i'
  ...
  VS Code:
    ...
    - name: 'Vite for VS Code'
      ...
      icon: 'i-carbon-flash'
    - name: 'Browse Lite'
      link: 'https://github.com/JessyTsui/vscode-browse-lite'
      desc: 'Embedded browser in VS Code'
      icon: 'i-uim-web-grid'
    - name: '文言 VS Code'
      link: 'https://github.com/JessyTsui/wenyan-lang-vscode'
      desc: '文言 Wenyan Lang for VS Code'
      icon: 'i-carbon-terminal'
    - name: 'Where am I ?'
      link: 'https://github.com/JessyTsui/vscode-where-am-i'
  ...
  Utilities:
    ...
    - name: 'qr-scanner-wechat'
      link: 'https://github.com/JessyTsui/qr-scanner-wechat'
  ...
  Configurations:
    ...
    - name: 'vscode-settings'
      link: 'https://github.com/JessyTsui/vscode-settings'
      desc: 'My VS Code settings'
      icon: 'i-simple-icons:visualstudiocode'
    - name: 'vscode-file-nesting-config'
      link: 'https://github.com/JessyTsui/vscode-file-nesting-config'
  ...
  Websites / Online Tools:
    ...
    - name: 'QR Toolkit'
      link: 'https://qrcode.JessyTsui.me/'
    ...
    - name: 'Prism --theme-vars'
      link: 'https://github.com/JessyTsui/prism-theme-vars'
      desc: 'A customizable Prism.js theme using CSS variables'
      icon: 'i-carbon-angle'
    - name: 'ReX'
      link: 'https://rex.JessyTsui.me/'
  ...
  Windi CSS Ecosystem:
    ...
    - name: 'Windi Runtime DOM'
      link: 'https://github.com/JessyTsui/windicss-runtime-dom'
  ...
  User Scripts:
    - name: 'Refined GitHub Notification'
      link: 'https://github.com/JessyTsui/refined-github-notifications'
      desc: 'Enhances the GitHub Notifications, more productive and less noisy.'
      icon: 'i-carbon:box'
    - name: 'Clean Twitter'
      link: 'https://github.com/JessyTsui/userscript-clean-twitter'
      desc: 'Bring back the peace on Twitter'
      icon: 'i-ion-logo-twitter'

  Toys:
    - name: '1990 Script'
      link: 'https://github.com/JessyTsui/1990-script'
